...
# LATITUDE #
class_knn_latitude <- FNN::knn.reg(train = trainmodel[, WAPS], 
                                   y= trainmodel$LATITUDE,
                                   test= validationData_1[,WAPS])

# LONGITUDE #

class_knn_longitude <- FNN::knn.reg(train = trainmodel[, WAPS], 
                                    y= trainmodel$LONGITUDE,
                                    test= validationData_1[,WAPS])


validationData_1$LATITUDE <- class_knn_latitude[["pred"]]
validationData_1$LONGITUDE <- class_knn_longitude[["pred"]]
